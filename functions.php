...
if (!is_admin()) add_action('wp_enqueue_scripts', 'evtvmarket_jquery_enqueue');
function evtvmarket_jquery_enqueue() {
...
add_action( 'after_setup_theme', 'evtvmarket_register_navwalker' );
function evtvmarket_register_navwalker(){
...
load_theme_textdomain( 'evtvmarket', get_template_directory() . '/languages' );
...
register_nav_menus( array(
    'header_menu' => __( 'Menu Header - Principal', 'evtvmarket' )
) );
...
add_action( 'widgets_init', 'evtvmarket_widgets_init' );
function evtvmarket_widgets_init() {
    register_sidebar( array(
        'name' => __( 'Sidebar Principal', 'evtvmarket' ),
        'id' => 'main_sidebar',
        'description' => __( 'Estos widgets seran vistos en las entradas y páginas del sitio', 'evtvmarket' ),
    ...
    register_sidebars( 4, array(
        'name'          => __('Footer Section %d', 'evtvmarket'),
        'id'            => 'sidebar_footer',
        'description'   => __('Footer Section', 'evtvmarket'),
        'before_widget' => '<li id="%1$s" class="widget %2$s">',
        'after_widget'  => '</li>',
        'before_title'  => '<h2 class="widgettitle">',
        'after_title'   => '</h2>'
    ...
    //    register_sidebar( array(
    //        'name' => __( 'Shop Sidebar', 'evtvmarket' ),
    //        'id' => 'shop_sidebar',
    //        'description' => __( 'Estos widgets seran vistos en Tienda y Categorias de Producto', 'evtvmarket' ),
    //        'before_widget' => '<li id='%1$s' class='widget %2$s'>',
    //        'after_widget'  => '</li>',
    //        'before_title'  => '<h2 class='widgettitle'>',
    //        'after_title'   => '</h2>',
...
function dashboard_footer() {
    ...
    _e ('Gracias por crear con ', 'evtvmarket' );
    echo '<a href="http://wordpress.org/" target="_blank">WordPress.</a> - ';
    _e ('Tema desarrollado por ', 'evtvmarket' );
    echo '<a href="http://robertochoa.com.ve/?utm_source=footer_admin&utm_medium=link&utm_content=evtvmarket" target="_blank">Robert Ochoa</a></span>';
}
