<?php
add_action( 'tgmpa_register', 'evtvmarket_register_required_plugins' );
 ...
 */
function evtvmarket_register_required_plugins() {
    /*
     ...
     */
    $config = array(
        'id'           => 'evtvmarket_tgmpa',                 // Unique ID for hashing notices for multiple instances of TGMPA.
