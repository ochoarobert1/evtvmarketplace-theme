...
add_action( 'after_setup_theme', 'evtvmarket_woocommerce_support' );
function evtvmarket_woocommerce_support() {
...
add_action('woocommerce_before_main_content', 'evtvmarket_woocommerce_custom_wrapper_start', 10);
add_action('woocommerce_after_main_content', 'evtvmarket_woocommerce_custom_wrapper_end', 10);

function evtvmarket_woocommerce_custom_wrapper_start() {
    echo '<section id="main" class="container-fluid"><div class="row"><div class="woocustom-main-container col-12">';
}

function evtvmarket_woocommerce_custom_wrapper_end() {
